...
export default function Create() {
    ...
    return (
        <AdminLayout title="Tambah Program Kesiswaan">
            <Head title="Tambah Program Kesiswaan" />
            ...
            <div className="mb-6 rounded-[28px] bg-gradient-to-br from-[#061b46] to-[#0b3b85] p-6 text-white shadow-2xl shadow-blue-200 sm:p-8">
                ...
                <h1 className="mt-3 text-[34px] font-black leading-tight tracking-[-0.05em] sm:text-[42px]">
                    Tambah Program Kesiswaan
                </h1>

                <p className="mt-4 max-w-2xl text-[14px] font-medium leading-7 text-blue-100">
                    Tambahkan program kesiswaan baru beserta detail form
                    pendaftarannya.
                </p>
            </div>
                        ...
                        <section className="rounded-[28px] border border-slate-200 bg-white p-6 shadow-xl shadow-slate-200/70 sm:p-8">
                            ...
                            <div className="mt-7 grid gap-5 md:grid-cols-2">
                                ...
                                <Input
                                    ...
                                    placeholder="Form Pendaftaran OSIS"
                                />
                                ...
                                <div className="md:col-span-2">
                                    <Input
                                        ...
                                        placeholder="Pendaftaran Pengurus OSIS dan Program Kepemimpinan"
                                    />
                                </div>
                        ...
                        <section className="rounded-[28px] border border-slate-200 bg-white p-6 shadow-xl shadow-slate-200/70 sm:p-8">
                            ...
                            <div className="mt-7 grid gap-5 md:grid-cols-2">
                                ...
                                <Input
                                    ...
                                    placeholder="Bidang yang Diminati"
                                />
                                ...
                                <div className="md:col-span-2">
                                    <Textarea
                                        ...
                                        placeholder="Isi data diri dan alasan mengikuti program."
                                        rows={3}
                                    />
                                </div>
                                ...
                                <Input
                                    ...
                                    placeholder="Alasan Mengikuti OSIS"
                                />
                                ...
                                <div className="md:col-span-2">
                                    <ArrayRepeater
                                        ...
                                        onAdd={() => addArray("interest_options")}
