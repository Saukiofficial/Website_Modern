...
function NewsCard({ item }) {
    return (
        <article className="overflow-hidden rounded-[18px] border border-slate-200 bg-white shadow-xl shadow-slate-200/70 transition duration-300 hover:-translate-y-1 hover:shadow-2xl">
            <div className="h-[210px] overflow-hidden bg-slate-100">
                <img
                    src={item.image}
                    alt={item.title}
            ...
            <div className="p-6">
                ...
                <h3 className="mt-5 font-serif text-[26px] font-semibold leading-tight tracking-[-0.035em] text-[#061b46]">
                    {item.title}
                </h3>

                <p className="mt-4 text-[14px] font-medium leading-7 text-slate-600">
                    Informasi resmi sekolah yang dapat diakses oleh siswa,
            ...
            <section className="w-full bg-[#f4f8fc] px-4 py-12 sm:px-6 lg:px-10 lg:py-16 xl:px-14 2xl:px-16">
                <div className="grid gap-8 xl:grid-cols-[1fr_0.44fr] xl:items-start">
                    ...
                    <aside className="rounded-[28px] bg-gradient-to-br from-[#052b66] to-[#063f8d] p-7 text-white shadow-2xl shadow-blue-200 sm:p-9">
                        ...
                        <a
                            href="#"
                            className="mt-7 inline-flex min-h-[56px] w-full items-center justify-center gap-3 rounded-[8px] border border-[#d5a542] px-7 text-[14px] font-semibold text-[#d5a542] transition hover:bg-white/10"
                        >
