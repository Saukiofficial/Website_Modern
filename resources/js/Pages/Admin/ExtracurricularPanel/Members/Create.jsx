...
export default function Create({ programs = [] }) {
    ...
    const handleSubmit = (event) => {
        ...
        post("/admin/ekstrakurikuler/members", {
            preserveScroll: true,
        });
    };

    return (
        <ExtracurricularAdminLayout title="Tambah Anggota Ekskul">
            <Head title="Tambah Anggota Ekskul" />
            ...
            <div className="mb-6 rounded-[28px] bg-gradient-to-br from-[#052b66] to-[#0f766e] p-6 text-white shadow-2xl shadow-blue-200 sm:p-8">
                ...
                <h1 className="mt-3 text-[34px] font-black leading-tight tracking-[-0.05em] sm:text-[42px]">Tambah Anggota Ekskul</h1>
                <p className="mt-4 max-w-2xl text-[14px] font-medium leading-7 text-blue-100">
                    Tambahkan anggota ekstrakurikuler secara manual.
                </p>
            </div>
