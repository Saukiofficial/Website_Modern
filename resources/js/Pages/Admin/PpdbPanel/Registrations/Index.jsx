...
export default function Index({
    ...
    return (
        <PpdbAdminLayout title="Pendaftar PPDB">
            ...
            <div className="overflow-hidden rounded-[28px] border border-slate-200 bg-white shadow-xl shadow-slate-200/70">
                {rows.length > 0 ? (
                    ...
                    <div className="px-6 py-16 text-center">
                        ...
                        <h3 className="mt-4 text-[24px] font-black tracking-[-0.04em] text-[#061b46]">
                            Belum Ada Pendaftar
                        </h3>

                        <p className="mx-auto mt-2 max-w-md text-[14px] font-semibold leading-7 text-slate-500">
                            Data pendaftar PPDB akan tampil di sini setelah
                            calon siswa mengisi formulir pendaftaran.
                        </p>
