                ...
                {statItems.map((item, index) => (
                    ...
                    >
                        ...
                        <div className="min-w-0">
                            ...
                            <p className="mt-2 text-[12px] font-bold text-slate-600 sm:text-[12.5px]">
                                {item.label}
                            </p>
                        </div>
                    </div>
                        ...
                        {categoryList.map((category) => {
                            ...
                            return (
                                <button
                                    ...
                                    className={`h-11 shrink-0 rounded-[12px] px-4 text-[11px] font-semibold transition sm:px-5 sm:text-[12px] ${
                                        isActive
                    ...
                    <div className="relative z-10 grid min-h-[250px] items-center gap-5 px-5 py-6 sm:gap-6 sm:px-8 sm:py-7 lg:grid-cols-[92px_1fr] lg:px-10">
                        ...
                        <div>
                            ...
                            <div className="mt-4 flex flex-col gap-3 sm:mt-5 sm:flex-row">
                                <a
                                    href="#"
                                    className="inline-flex min-h-[48px] items-center justify-center rounded-[12px] bg-[#f7b733] px-6 text-[13px] font-semibold text-[#061b46] transition hover:bg-yellow-300 sm:min-h-[50px] sm:px-7"
                                >
                                ...
                                <a
                                    href="#"
                                    className="inline-flex min-h-[48px] items-center justify-center rounded-[12px] border border-white/30 bg-white/10 px-6 text-[13px] font-semibold text-white backdrop-blur-sm transition hover:bg-white/15 sm:min-h-[50px] sm:px-7"
                                >
                                    Hubungi Kesiswaan
                                </a>
                            </div>
