...
export default function Show({ registration }) {
    ...
    const handleDelete = () => {
        if (confirm("Yakin ingin menghapus data pendaftar ini?")) {
            router.delete(`/admin/ppdb/registrations/${registration.id}`);
        }
    };

    return (
        <PpdbAdminLayout title="Detail Pendaftar PPDB">
                    ...
                    >
                        ...
                        <div className="mt-6 space-y-5">
                            ...
                            <button
                                type="submit"
                                disabled={processing}
                                className="inline-flex min-h-[50px] w-full items-center justify-center rounded-[16px] bg-[#061b46] px-6 text-[13px] font-extrabold uppercase tracking-[0.08em] text-white transition hover:bg-[#0b3b85] disabled:opacity-60"
                            >
                            ...
                            <button
                                ...
                                className="inline-flex min-h-[50px] w-full items-center justify-center rounded-[16px] bg-red-50 px-6 text-[13px] font-extrabold uppercase tracking-[0.08em] text-red-700 transition hover:bg-red-100"
                            >
                                Hapus Data
                            </button>
                        </div>
