...
class AcademicOsisMemberController extends Controller
{
    public function index(): Response
    {
        ...
        return Inertia::render('Admin/Academics/OsisMembers/Index', [
    ...
    {
        return Inertia::render('Admin/Academics/OsisMembers/Create');
    }
    ...
    public function store(Request $request): RedirectResponse
    {
        ...
        return redirect()
            ->route('admin.academics.osis-members.index')
            ->with('success', 'Data pengurus OSIS berhasil ditambahkan.');
    }

    public function edit(OsisMember $osisMember): Response
    {
        return Inertia::render('Admin/Academics/OsisMembers/Edit', [
            'osisMember' => [
                'id' => $osisMember->id,
                'name' => $osisMember->name,
                'position' => $osisMember->position,
                'class_name' => $osisMember->class_name,
                'description' => $osisMember->description,
                'image' => $osisMember->image,
                'image_url' => $osisMember->image_url,
                'period' => $osisMember->period,
                'sort_order' => $osisMember->sort_order,
                'is_leader' => $osisMember->is_leader,
                'is_active' => $osisMember->is_active,
            ],
        ]);
    }
